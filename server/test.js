...
const ALPACA_KEY = "PKWNLJGV4ZY32L2B3CMDM4ZFVC";
const ALPACA_SECRET = "9ms3imgMXkyduN8R1jRP9JGE6RG45PWmCgAnvpCTW71Z";
...
app.post('/api/fetch', async (req, res) => {
    try {
        ...
        console.log(t1MinuteStartISO);
        console.log(t1MinuteEndISO);
